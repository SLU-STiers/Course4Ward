...
const MOCK_PATIENTS: {
  ...
  { id: '1', name: 'Sarah Brown', patientId: '1123', admissionDate: '15/04/2026', color: '#22c55e', status: 'admitted' },
  { id: '2', name: 'Michael Owen', patientId: '1122', admissionDate: '15/04/2026', color: '#22c55e', status: 'admitted' },
  { id: '3', name: 'Mary Jane', patientId: '1121', admissionDate: '14/04/2026', color: '#22c55e', status: 'admitted' },
  { id: '4', name: 'Peter Doolie', patientId: '1120', admissionDate: '14/04/2026', color: '#22c55e', status: 'admitted' },
  { id: '5', name: 'Peter Doolie', patientId: '1119', admissionDate: '14/04/2026', color: '#22c55e', status: 'admitted' },
  { id: '6', name: 'Peter Doolie', patientId: '1118', admissionDate: '15/04/2026', color: '#22c55e', status: 'admitted' },
  { id: '7', name: 'Liam Park', patientId: '1117', admissionDate: '15/04/2026', color: '#22c55e', status: 'admitted' },
  { id: '8', name: 'Nora Reyes', patientId: '1116', admissionDate: '16/04/2026', color: '#22c55e', status: 'admitted' },
  { id: '9', name: 'James Cruz', patientId: '1115', admissionDate: '16/04/2026', color: '#22c55e', status: 'admitted' },
  { id: '10', name: 'Elena Santos', patientId: '1114', admissionDate: '17/04/2026', color: '#22c55e', status: 'admitted' },
  { id: '11', name: 'Carlos Vega', patientId: '1113', admissionDate: '17/04/2026', color: '#22c55e', status: 'admitted' },
  { id: '12', name: 'Ava Lim', patientId: '1112', admissionDate: '18/04/2026', color: '#22c55e', status: 'admitted' },
  { id: '13', name: 'Ben Torres', patientId: '1111', admissionDate: '10/04/2026', color: '#ef4444', status: 'discharged' },
  { id: '14', name: 'Mia Chen', patientId: '1110', admissionDate: '09/04/2026', color: '#ef4444', status: 'discharged' },
  { id: '15', name: 'Owen Blake', patientId: '1109', admissionDate: '08/04/2026', color: '#ef4444', status: 'discharged' },
  { id: '16', name: 'Ruby Diaz', patientId: '1108', admissionDate: '07/04/2026', color: '#ef4444', status: 'discharged' },
  { id: '17', name: 'Noah Kim', patientId: '1107', admissionDate: '06/04/2026', color: '#ef4444', status: 'discharged' },
  { id: '18', name: 'Ivy Morales', patientId: '1106', admissionDate: '05/04/2026', color: '#ef4444', status: 'discharged' },
  { id: '19', name: 'Leo Santos', patientId: '1105', admissionDate: '04/04/2026', color: '#ef4444', status: 'discharged' },
  { id: '20', name: 'Paula Reed', patientId: '1104', admissionDate: '03/04/2026', color: '#ef4444', status: 'discharged' },
];
    ...
    <div style={shell.appContainer}>
      ...
      <div style={shell.mainWrapper}>
        <header style={shell.header}>
          <div>
            <h1 style={shell.headerTitle}>Physician</h1>
          </div>
          <NotificationBell />
        </header>
